...
const Feedback = () => {
  ...
  return (
    <div className="relative isolate overflow-hidden bg-neutral py-16 sm:py-24 lg:py-16 rounded-xl shadow-md">
        ...
        <div className="flex flex-row gap-12">
          <div className="w-full">
            ...
            <form className="mt-6 flex flex-col gap-5 items-center max-w-md gap-x-4" onSubmit={handleSubmit}>
              ...
              />
              <button
                className={`btn w-32 ${sendSuccess ? "btn-secondary" : sendError ? "btn-error" : "btn-primary"} text-lg`}
                type="submit">
                {!isLoading ? (
                  sendSuccess ? (
                    <>
