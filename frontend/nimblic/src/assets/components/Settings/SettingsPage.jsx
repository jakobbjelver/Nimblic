...
const SettingsPage = () => {
    ...
    return (
        <>
            <div className="w-full max-w-screen-xl overflow-x-hidden bg-base-100 px-12 py-4 fadeInUp">
                <div className="flex flex-col gap-8">
                    <div className="card w-full h-60 bg-base-200">
                            ...
                            <div>
                                <div className="flex flex-col gap-6 items-center justify-center w-full">
                                    <div className="flex flex-row w-full items-center gap-16 justify-center">
                                        <div className={`settings-beginner z-[2] w-40 transition-all duration-400 ease-in-out ${settings?.skillLevel === 'beginner' ? 'scale-125 opacity-100' : 'opacity-90 scale-90'}`}/>
                                        <div className={`settings-intermediate z-[2] w-40 transition-all duration-400 ease-in-out ${settings?.skillLevel === 'intermediate' ? 'scale-125 opacity-100' : 'opacity-90 scale-90'}`} />
                                        <div className={`settings-expert z-[2] w-40 transition-all duration-400 ease-in-out ${settings?.skillLevel === 'expert' ? 'scale-125 opacity-100' : 'opacity-90 scale-90'}`} />                                    </div>
                                    <div className="join">                                      
                                        <input
                    ...
                    <div className="flex xl:flex-row lg:flex-col gap-6 mb-8 xl:items-start lg:items-center justify-evenly">
                        <div className="flex flex-col gap-6 items-stretch justify-evenly">
                            <div className="flex flex-row gap-6">
                                ...
                                <div className="card w-full h-40 bg-base-200">
                                    <div className="card-body">
                                        <h2 className="card-title text-md text-neutral-content/90 font-bold font-nunito">ENCRYPTION</h2>
                                        <div className="flex flex-col w-full h-full items-center justify-center">
                            ...
                            <div className="flex flex-row items-center justify-center">
                                ...
                                <Link to="/privacy" className="w-1/3 mx-8">
                                    <div className="btn card w-full h-30 bg-base-200">
                                        <div className="card-body flex flex-row items-center justify-center group">
