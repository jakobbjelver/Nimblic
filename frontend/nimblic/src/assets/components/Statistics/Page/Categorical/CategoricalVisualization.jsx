...
const CategoricalVisualization = ({ categoricalData, selectedCategory, isLoading }) => {
    ...
    useEffect(() => {
        ...
        if (Object.keys(categoricalData).length > 0 && selectedCategory && !isLoading) {
            ...
            if (!categoryData) {
                console.log("distr loading true")

                setDistributionLoading(true)
            } else {
                setDistributionLoading(false)
                console.log("distr loading false")
                ...
                console.log("setMaxNumItems", numItems)
            ...
            console.log("actual null set null")
    ...
    useEffect(() => {
        ...
        console.log("selectedNumericalColumn updates")
    ...
    useEffect(() => {
        ...
        if (!isNull && categoricalData[selectedCategory]) {
            ...
            if (sortOrder.includes('Frequency')) {
                ...
                if (!sortedResult) {
                    console.log("sort freq set null")
                    //setNull(true)
                    return
                } else {
                    setNull(false)
                ...
                if (!sortedResult || isDistributionLoading) {
                    console.log("sort distr set null")
                    //setNull(true)
                    return
                } else {
                    setNull(false)
            ...
            //console.log("sortedResult.mappedDataset! for f", sortedResult.mappedDataset)
            //console.log("sortedResult.sortedDataset! for d", sortedResult.sortedDataset)
    ...
    const renderBoxPlot = () => {
        ...
        if (!boxPlotOptions) {
            console.log("boxPlotOptions null!")
            return null
        }
