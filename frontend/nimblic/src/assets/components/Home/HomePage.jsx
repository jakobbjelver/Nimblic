...
const HomePage = () => {
  ...
  return (
    <>
      <div className="flex flex-col items-center mt-10 w-full h-dvh">
        <div className="flex flex-col w-screen max-w-screen-2xl lg:px-32 md:px-16 md:h-screen sm:h-fit p-6">
          <ParallaxProvider>
            <main className="md:flex-grow sm:flex-grow-0 flex lg:flex-row xl:flex-row 2xl:flex-row">
              <div className="flex flex-col w-full lg:w-2/3 md:w-2/3 text-left md:pb-16 pt-16 fadeInUp md:h-auto sm-fit">
                ...
                <br></br>
                <p className="text-md font-bold text-neutral-content/90">
            ...
            <div className={`fixed top-full md:mt-[-90px] mt-[-110px] z-[99] left-1/2 animate-bounce transition-all duration-200 ease-in-out ${isScrolled ? 'opacity-0' : 'opacity-100'}`}>
              <FontAwesomeIcon icon={faArrowDown} size="1x" className="-translate-x-1/2 rounded-full md:bg-base-300/70 bg-base-300 md:w-5 md:h-5 h-6 w-6 md:p-2 p-2.5 text-secondary/90 shadow-xl" />
            </div>
          </ParallaxProvider>
        </div>
        <Feature />
