      ...
      <Dialog as="div" className="relative z-[9999]" initialFocus={cancelButtonRef} onClose={closeModal}>
        ...
        <div className="fixed inset-0 z-[99999] w-screen overflow-y-auto">
          <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
            ...
            >
              <Dialog.Panel className="relative transform overflow-hidden rounded-lg bg-base-200 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-xl">
                <button
                ...
                <div className="bg-base-200 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-4 gap-2">
