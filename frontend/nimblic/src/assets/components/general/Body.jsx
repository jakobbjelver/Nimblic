...
const Body = ({ children }) => {
    ...
    return (
        isNarrowScreen && showSidebar ?
            ...
            <div className="flex h-screen w-full overflow-y-visible items-stretch justify-between">
                ...
                <div className={`flex flex-col body justify-right items-end ${showSidebar ? 'lg:w-11/12 md:w-11/12 xl:w-5/6 2xl:w-5/6' : 'w-full'}`}>
                    ...
                    <AlertSection />
                    <main className="flex w-full items-center justify-center mt-20">{children}</main>
