...
const FileUploadProvider = ({ children }) => {
  ...
  useEffect(() => {
    try {
      ...
      setUploadError({
        type: "warning",
        short: "Problem during data analysis",
        long: "Your file is too large to save to your local storage. The app might not work as expected. If you leave the page your analysis will get lost. Please try uploading a smaller file or remove other analyses.",
        time: getCurrentTime()
      })
    }
  }, [uploadData]);
